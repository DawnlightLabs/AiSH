...
export default function App() {
  ...
  return (
    <main className="app-shell">
      ...
      <SettingsDrawer open={settingsOpen} profiles={profiles} selectedProfileId={selectedProfileId} showFullReasoning={showFullReasoning} appMode={appMode} logSettings={logSettings} contextMode={contextMode} onChangeAppMode={setAppMode} onChangeContextMode={setContextMode} onClearWorking={ai.reset} onSelectProfile={setSelectedProfileId} onToggleFullReasoning={setShowFullReasoning} onChangeLogSettings={updateLogSettings} onClose={() => setSettingsOpen(false)} />
    </main>
  );
}
